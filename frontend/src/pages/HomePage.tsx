    ...
    <div className="relative min-h-screen overflow-x-hidden text-white" style={{ background: 'linear-gradient(to bottom right, var(--dark-gradient-start), var(--dark-gradient-mid), var(--dark-gradient-end))' }}>
      ...
      >
        <div className="flex items-center">
          <img src="/logo.png" alt="ContextFlow" className="h-9 w-auto object-contain" style={{ filter: 'drop-shadow(0 2px 8px rgba(0,0,0,0.7))' }} />
        </div>
      ...
      <footer className="relative z-10 border-t border-white/10 mt-8 py-8 px-6">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center">
            <img src="/logo.png" alt="ContextFlow" className="h-7 w-auto object-contain" style={{ filter: 'drop-shadow(0 2px 6px rgba(0,0,0,0.7))' }} />
          </div>
